...
import { validateRequirements, validateRequirementsStructure, REQUIREMENTS_SCHEMA } from './validation-schema';
 ...
 */
export async function validateRequirementsFormat(requirements: PhaseRequirement[]): Promise<RequirementValidationResult[]> {
  try {
 ...
 */
export async function validatePhaseRequirementsStructure(phaseRequirements: PhaseRequirements): Promise<RequirementValidationResult> {
  try {
