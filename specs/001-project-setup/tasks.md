...
- [ ] T001 Initialize Next.js 16 project with App Router using project initialization command
- [ ] T002 Configure TypeScript and install React 19 dependency in package.json
- [ ] T003 [P] Install Tailwind CSS and its dependencies in package.json
- [ ] T004 [P] Install code quality tools (ESLint, Prettier) in package.json
- [ ] T005 Create directory structure: components/, hooks/, lib/ at project root
- [ ] T006 Create placeholder .gitkeep files in components/, hooks/, lib/
...
- [ ] T007 Configure Tailwind CSS in tailwind.config.ts with dark mode enabled
- [ ] T008 [P] Create app/globals.css with Tailwind directives and dark mode styles
- [ ] T009 [P] Configure ESLint rules in .eslintrc.json for project standards
- [ ] T010 [P] Configure Prettier in .prettierrc for code formatting
- [ ] T011 [P] Configure TypeScript in tsconfig.json for Next.js 16 compatibility
- [ ] T012 [P] Configure Next.js 16 in next.config.js with App Router settings
- [ ] T013 Update package.json scripts: dev, build, start, lint, format, type-check
...
- [ ] T014 [P] [US1] Create app/layout.tsx with root layout and HTML structure
- [ ] T015 [US1] Apply dark mode configuration in app/layout.tsx using Tailwind dark mode class
- [ ] T016 [P] [US1] Create app/page.tsx with default landing page content
- [ ] T017 [US1] Style app/page.tsx with dark mode classes for initial page display
- [ ] T018 [US1] Configure public/favicon.ico for browser tab icon
...
- [ ] T019 [P] [US2] Create .eslintrc.json with ESLint configuration for React and TypeScript rules
- [ ] T020 [P] [US2] Create .prettierrc with Prettier formatting rules (tabs, semicolons, quotes)
- [ ] T021 [US2] Add lint script to package.json that runs ESLint on all source files
- [ ] T022 [US2] Add format script to package.json that runs Prettier with write mode
- [ ] T023 [US2] Add type-check script to package.json that runs TypeScript compiler with noEmit
- [ ] T024 [US2] Configure pre-commit hook to run linting (optional, if supported by project setup)
...
- [ ] T025 [P] Create README.md with project overview, setup instructions, and quick reference
- [ ] T026 [P] Verify all scripts in package.json work correctly (dev, build, lint, format, type-check)
- [ ] T027 Test development server startup and verify no console errors
- [ ] T028 Verify dark mode styling is applied correctly on the default page
- [ ] T029 Verify all required directories (components, hooks, lib) exist and are accessible
